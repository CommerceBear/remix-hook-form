...
var useRemixForm = ({
  ...
  var _a, _b;
  const [isSubmittedSuccessfully, setIsSubmittedSuccessfully] = (0, import_react2.useState)(false);
  ...
  const onSubmit = (0, import_react2.useMemo)(
  ...
  const onInvalid = (0, import_react2.useMemo)(() => () => {
  }, []);
  const formState = (0, import_react2.useMemo)(
    () => ({
      get isDirty() {
  ...
  const reset = (0, import_react2.useMemo)(
    () => (values, options) => {
  ...
  const register = (0, import_react2.useMemo)(
    () => (name, options) => {
      var _a2;
  ...
  const handleSubmit = (0, import_react2.useMemo)(
    () => (e) => {
      var _a2, _b2, _c, _d;
  ...
  const hookReturn = (0, import_react2.useMemo)(
    () => ({
      ...methods,
      handleSubmit,
      reset,
